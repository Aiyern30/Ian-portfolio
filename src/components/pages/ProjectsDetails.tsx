        ...
        {isDetailModalOpen && detailProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
            ...
            <motion.div
              ...
              className="relative w-full max-w-6xl bg-[#1a0b2e] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl max-h-full overflow-y-auto hide-scrollbar"
            ...
            >
              <button
                onClick={() => setIsDetailModalOpen(false)}
                className="absolute top-8 right-8 z-50 p-3 bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-md border border-white/10 transition-colors"
              >
                <X className="w-6 h-6" />
              </button>
              ...
              <div className="flex flex-col lg:flex-row min-h-[600px]">
                ...
                <div className="lg:w-3/5 relative min-h-[400px]">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#1a0b2e] via-transparent to-transparent hidden lg:block" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1a0b2e] via-transparent to-transparent lg:hidden" />
                </div>

                {/* Modal Content */}
                <div className="lg:w-2/5 p-8 md:p-12 flex flex-col justify-center">
                  <div className="space-y-6">
                    <span className="px-4 py-1 rounded-full bg-[#FF9D7A]/20 text-[#FF9D7A] text-xs font-bold uppercase tracking-widest">
                      {detailProject.category}
                    </span>
                    <h2 className="text-3xl md:text-5xl font-bold font-primary leading-tight">
                      {detailProject.title}
                    </h2>
                    <p className="text-gray-400 font-secondary leading-relaxed text-lg">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {detailProject.label.map((tech) => (
                          <span
                            key={tech}
                            className="px-3 py-1 bg-white/5 border border-white/5 rounded-md text-sm text-gray-300"
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div className="flex flex-wrap gap-4 pt-8">
                      {detailProject.livePreviewUrl && (
                        <button
                          ...
                          className="flex-1 min-w-[160px] flex items-center justify-center gap-2 px-8 py-4 bg-[#FF9D7A] text-white font-bold rounded-2xl hover:bg-[#FF9D7A]/90 transition-all shadow-[0_4px_20px_rgba(255,157,122,0.3)]"
                        >
                      ...
                      {detailProject.githubRepo && (
                        <button
                          ...
                          className="flex-1 min-w-[160px] flex items-center justify-center gap-2 px-8 py-4 bg-white/5 border border-white/10 font-bold rounded-2xl hover:bg-white/10 transition-all"
                        >
